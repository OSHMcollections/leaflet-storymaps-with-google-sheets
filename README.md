...
- The map is hosted by GitHub and can be found at  https://oshmcollections.github.io/leaflet-storymaps-with-google-sheets/
- Google Sheets template https://docs.google.com/spreadsheets/d/1VQawijCvFYigzqDeR3kb3KkcRgCvZlEykMYJCeymEj8/edit#gid=0
